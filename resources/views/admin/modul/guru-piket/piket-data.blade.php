        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="#">Guru Piket</a></div>
                    <div class="breadcrumb-item">Data Guru Piket</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Data Guru Piket</h2>
                                        ...
                                        <tbody>
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="POST"
                                                            action="{{ route('admin.guru-piket.destroy', $user->id) }}">
                                                            <a class="btn btn-success btn-sm"
                                                                href="{{ route('admin.guru-piket.edit', $user->id) }}"
                                                                role="button">Edit</a>
                                                            @csrf
                                                            @method('DELETE')
