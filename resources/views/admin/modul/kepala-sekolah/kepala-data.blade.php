        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="#">Kelola Kepala Sekolah</a></div>
                    <div class="breadcrumb-item">Data Kepala Sekolah</div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="POST"
                                                            action="{{ route('admin.kepala-sekolah.destroy', $user->id) }}">
                                                            <a class="btn btn-success btn-sm"
                                                                href="{{ route('admin.kepala-sekolah.edit', $user->id) }}"
                                                                role="button">Edit</a>
                                                            @csrf
                                                            @method('DELETE')
