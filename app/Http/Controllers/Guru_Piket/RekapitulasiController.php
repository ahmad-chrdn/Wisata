...
class RekapitulasiController extends Controller
{
    public function show($id)
    {
        ...
        return view('guru-piket.modul.rekapitulasi.rekap', compact('kelas', 'jurusans', 'semesters'));
    }
    ...
    public function rekapitulasi(Request $request, $id)
    {
        ...
        return view('guru-piket.modul.rekapitulasi.rekap', compact('rekapitulasi', 'kelas', 'jurusans', 'semesters', 'jurusan_id', 'semester_id'));
    }
}
