...
class WaliKelasController extends Controller
{
    public function index(): View
    {
        ...
        return view('admin.modul.wali-kelas.wali-data', compact('users'));
    }

    public function create(): View
    {
        return view('admin.modul.wali-kelas.wali-create');
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin.modul.wali-kelas.wali-edit', compact('user'));
    }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        return redirect()->route('admin.wali-kelas.index')->with(['success' => 'Data berhasil diperbarui!']);
    }
